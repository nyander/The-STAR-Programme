<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <form method="POST" action="{{ route('categories.store') }}" class="bg-white p-8 rounded drop-shadow border-primary border-4">
        ...
        <div class="mb-4">
          ...
          <input class="border border-gray-400 p-2 w-full" type="text" name="category">
        </div>
