<x-app-layout>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        @endif
        <form method="POST" action="{{ route('performance-profile-templates.store') }}">
            @csrf
            ...
            <div class="default-section mb-4 relative">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="question-mark">
                        ...
                        <div
                            class="absolute hidden bg-white border border-gray-300 rounded-md shadow-lg text-gray-700 text-sm p-2 mt-1 w-4/6 z-10 question-mark-text">
                            By setting this Performance profile as default, if you do not set a specific Performance Profile for the client, they will be assigned this Profile for them to fill.
                        </div>
                    </div>
                </div>
                <div class="field">
                    <div class="relative">
                        <select name="default_value" id="default_value" class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
